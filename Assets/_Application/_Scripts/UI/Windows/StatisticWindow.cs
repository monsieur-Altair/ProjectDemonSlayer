...
namespace _Application.Scripts.UI.Windows
{
    ...
    {
        [SerializeField] private TextMeshProUGUI _gainedMana;
        [SerializeField] private TextMeshProUGUI _spentMana;
        [SerializeField] private TextMeshProUGUI _conqueredBuildings;
        [SerializeField] private TextMeshProUGUI _missedBuildings;
        [SerializeField] private TextMeshProUGUI _winCount;
        [SerializeField] private TextMeshProUGUI _usedSpells;
